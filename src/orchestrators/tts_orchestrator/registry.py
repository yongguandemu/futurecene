"""registry.py — TTS 调度官内部能力注册表（规格书 5.2）
...
# 模块内容清单（8 项契约）
1. 模块身份标识：tts · registry · 能力注册表（tts:synthesize/stream_synthesize/stop/cache_clean）
2. 配置契约：无
...
HANDLERS = {
    ...
    "tts:stream_synthesize": [object],
    "tts:stop": [object],
    "tts:cache_clean": [object],
}
